...
export default function DocsPage() {
  ...
  // 动态更新 SEO 标签
  useEffect(() => {
    document.title = 'Documentation - How to Use | 使用文档 - 线粒体分析平台';

    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Complete guide for mitochondrial protein analysis. Learn about parameters, threshold methods, results interpretation, API usage, and FAQs.');
    }

    const ogTitle = document.querySelector('meta[property="og:title"]');
    if (ogTitle) {
      ogTitle.setAttribute('content', 'Documentation - Mitochondrial Analysis Platform');
    }
